...
<html>
  <head>
    ...
    <title>Menu admin Kos awak</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <div class="logo">
          ...
          <span class="logo-mini"><img src="<?php echo base_url()."assets/"; ?>images/logo_min.png" alt="" style="width: 40px;height: 40px;padding: 0px 0px 3px 0px;"></span>
