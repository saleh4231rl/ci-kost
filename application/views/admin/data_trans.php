          ...
          <div class="col-xs-12">
              ...
              <div class="box">
                  <div class="box-header">
                      <span><a href="<?php echo base_url('index.php/admin/cetak_data_kos'); ?>"
                              class="btn btn-warning"><i class="fa fa-print"></i> Print</a>
                          <a href="<?php echo base_url()?>" class="btn btn-danger"><i
                                  class="fa fa-print">Print</i></a></span>
                      <!-- - php echo base amnggil
                      <I> untuk buat icon--->
                  </div><!-- /.box-header -->
                  <div class="box-body">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><img class="img-thumbnail"
                                          style="max-height:70px;max-width:120px;min-height:70px;min-width:120px;"
                                  ...
                                  <td>
                                      <p><a href="<?php echo base_url()."index.php/admin/ok_trans/".$data[$i]->no_fak_trans_us; ?>"
                                              class="btn btn-warning" data-placement="bottom" data-toggle="tooltip"
                                              title="Print"><i class="fa fa-print"></i></a></p>
                                  </td>
                                  </td>
