                     ...
                     <div class="col-lg-9 col-sm-9">
                         <div class="navbar navbar-default navbar-static-top" role="navigation">
                             ...
                             <div class="navbar-header">
                                 <button type="button" class="navbar-toggle rounded" data-toggle="collapse"
                             ...
                             <div class="navbar-collapse collapse">
                                 <ul class="nav navbar-nav">
                                     <li class="<?php if($this->uri->segment(2)=="index"){ echo "active"; } ?>"><a
                                             href="<?php echo site_url('kos/index'); ?>"> Home</a></li>



                                     <li class="<?php if($this->uri->segment(2)=="kontak"){ echo "active"; } ?>"><a
                                             href="<?php echo site_url('kos/kontak'); ?>"> Kontak</a></li>


                                     <li class="<?php if($this->uri->segment(2)=="daftar"){ echo "active"; } ?>"><a
                                             href="<?php echo site_url('kos/daftar'); ?>"> Daftar</a></li>
                                     <li><a href="#modal-index" data-toggle="modal" data-target="#modal-index" id="0"
             ...
             <div class="modal-dialog" role="document">
                 <div class="modal-content modal-login">
                     ...
                     <div class="modal-footer">
                         <button type="submit" class="btn btn-default btn-lg btn-login rounded" id="login"
