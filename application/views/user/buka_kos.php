 ...
 <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="sidebar">
                        <div class="widget_info">
                            ...
                            <br>
                            <p><i class="fa fa-angle-double-right"></i> Dengan mendaftar berarti anda sudah bersedia berkerja sama dengan kos awak dan diharapkan nomor telepon anda selalu aktif untuk kami beritahu jika ada informasi yang harus kami beritahu kepada anda.</p>
                            <br>
                            <p><i class="fa fa-angle-double-right"></i> Pastikan data kos anda sesuai dengan yang diinginan kos awak serta tidak melanggar undang-undang ,jika melanggar kos anda tidak akan kami proses atau tidak ditampilkan dimenu utama.</p>
                            <br>
