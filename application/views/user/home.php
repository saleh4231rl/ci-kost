 ...
 <head>
     ...
     <title>Selamat datang diKosawak</title>
 ...
 <body>
             ...
             <div class="container">
                 <div class="row">
                     ...
                     <div class="col-sm-4 top-info hidden-xs">
                         <ul>
                             <li><a href="<?php echo $kon->twit_k; ?>" class="my-tweet"><i
                                         class="fa fa-twitter"></i></a></li>
                             <li><a href="<?php echo $kon->fb_k; ?>" class="my-facebook"><i
                                         class="fa fa-facebook"></i></a></li>
                             <li><a href="<?php echo $kon->g_plus_k; ?>" class="my-google"><i
                         ...
                         <div class="navbar navbar-default navbar-static-top" role="navigation">
                             ...
                             <div class="navbar-collapse collapse">
                                 <ul class="nav navbar-nav">
                                     <li class="<?php if($this->uri->segment(2)=="index"){ echo "active"; } ?>"><a
                                             href="<?php echo site_url('user/index'); ?>"> Home</a></li>



                                     <li class="<?php if($this->uri->segment(2)=="kontak"){ echo "active"; } ?>"><a
                                             href="<?php echo site_url('user/kontak'); ?>"> Kontak</a></li>
                                     <?php
                                   ...
                                   ?>
                                     <li class="dropdown profil">
                                         ...
                                         <a href="#" class="dropdown-toggle a-profil" data-toggle="dropdown"
                                             role="button" aria-haspopup="true" aria-expanded="false">
                                             <?php foreach ($user as $us) { ?>
                                             <img class="img-profil"
                                                 src="<?php echo base_url()."assets/"; ?>images/use_r/<?php if($us->ft_us==""){ echo 'default.png'; }else { echo $us->ft_us;} ?>" />
                                             <span><?php echo $us->nml_us; ?></span></a>
                                         <?php } ?>
                                         <ul class="dropdown-menu">
                                             <li><a href="<?php echo base_url()."index.php/user/profil"; ?>"><i
                                                         class="fa fa-user"></i> Profil</a></li>
                                             <li><a href="<?php echo base_url()."index.php/user/data_pesanan"; ?>"><i
                                                         class="fa fa-shopping-cart"></i> Pesanan Saya</a></li>
                                             <li><a href="<?php echo base_url()."index.php/user/kelola_kos"; ?>"><i
                                                         class="fa fa-list-alt"></i> Kelola kos</a></li>
                 ...
                 <div class="col-sm-6 ">
                     <div class="footer_social">
                         ...
                         <ul class="footbot_social">
                             <li><a class="fb" href="<?php echo $kon->fb_k; ?>" data-placement="top"
                                     data-toggle="tooltip" title="Facbook"><i class="fa fa-facebook"></i></a></li>
                             <li><a class="twtr" href="<?php echo $kon->twit_k; ?>" data-placement="top"
                                     data-toggle="tooltip" title="Twitter"><i class="fa fa-twitter"></i></a></li>
                             <li><a class="gmail" href="<?php echo $kon->g_plus_k; ?>" data-placement="top"
                                     data-toggle="tooltip" title="Google"><i class="fa fa-google-plus"></i></a></li>
                             <li><a class="instagram" href="<?php echo $kon->instag_k ?>" data-placement="top"
                                     data-toggle="tooltip" title="Instagram"><i class="fa fa-instagram"></i></a></li>
                             <li><a class="youtube" href="<?php echo $kon->yt_k ?>" data-placement="top"
     ...
     <!-- jQuery cookie -->
     <script src="<?php echo base_url()."assets/"; ?>js/jquery.fractionslider.js" type="text/javascript"
         charset="utf-8"></script>
     <script type="text/javascript" src="<?php echo base_url()."assets/"; ?>js/jquery.smartmenus.min.js"></script>
     <script type="text/javascript" src="<?php echo base_url()."assets/"; ?>js/jquery.smartmenus.bootstrap.min.js">
     </script>
