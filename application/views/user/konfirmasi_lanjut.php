  <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <form id="contactForm" action="<?php echo base_url()."index.php/user/trans_bank"; ?>" method="post"
          ...
          <div class="row">
              <div class="form-group">
                  ...
                  <?php } ?>
                  <div class="col-lg-9">
                      <p>Silahkan lakukan transaksi ke nomor rekening kos awak yang ada dibawah dan lakukan pengisian
                          data berdasarkan transaksi yang telah dilakukan.</p>
                      <?php foreach ($rek as $rk) { ?>
                      <label for="exampleInputFile">Nomor Rekening BCA Kos Dewi</label>
                      <blockquote class="default">
                          <h2><?php echo $rk->no_rek; ?></h2>
                      </blockquote>
                      <?php } ?>
                      <p></p>
                      ...
                      <blockquote class="default">
                          <h3>Rp <?php echo number_format($dt->hrg_ks,0,".","."); ?></h3>
                      </blockquote>
                      <?php } ?>
                      <p></p>
          ...
          <div class="row">
              <div class="col-md-9 text-right">
                  <a href="<?php echo base_url()."index.php/user/konfirmasi/".$ps->id_psn_ks_us; ?>"
                      class="btn btn-default btn-md">Back</a>
      ...
      <form id="contactForm" action="<?php echo base_url()."index.php/user/trans_cod"; ?>" method="post">
          <div class="row">
              <div class="form-group">
                  ...
                  <?php } ?>
                  <div class="col-lg-9">
                      <p>Silahkan lakukan transaksi dengan pemilik kos agar bisa mendapatkan kos yang anda pesan dengan
                          membawa bukti pemesanan dari kos awak,untuk informasi lebih lanjut silahkan hubungi nomor
                          telepon pemilik kos dibawah.<b>Terima Kasih</b>.</p>
                      <?php foreach ($dtpem as $dt) { ?>
                      <label for="exampleInputFile">Nama Pemilik kos</label>
                      <blockquote class="default">
                          <h3><?php echo $dt->nml_us; ?></h3>
                      </blockquote>
                      <p></p>
                      <label for="exampleInputFile">No Telepon Pemilik Kos</label>
                      <blockquote class="default">
                          <h2><?php echo $dt->no_hp_us; ?></h2>
                      </blockquote>
                      <p></p>
                      <label for="exampleInputFile">Total yang harus dibayar</label>
                      <blockquote class="default">
                          <h4>Rp <?php echo number_format($dt->hrg_ks,0,".","."); ?></h4>
                      </blockquote>
                      <?php } ?>
